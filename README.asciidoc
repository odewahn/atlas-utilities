...
You won't be able to access the app until the CNAME is set up.  O'Reilly runs it's own DNS server, so we set up the CNAME in a a mysql database.  It should look like this:
